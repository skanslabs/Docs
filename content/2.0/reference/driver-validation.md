...
*Table + counts generated 2026-07-17 13:47 UTC from the validation ledger via `SkansCP --driver-validation` — never hand-edited.*

**Cert-deploy (120 drivers):** 8 hardware-validated · 8 emulation-validated · 1 known-issue · **103 spec-verified (pending a device)**. The monitor columns (SNMP/syslog) are marked only where a real device proved them.
